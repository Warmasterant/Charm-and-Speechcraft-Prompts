SkyrimNet Speech and Charm Prompts

The mod contains two prompt files for Skyrimnet, written mostly by Codex. 

The Speechcraft prompt gives ever increasing direction to NPCs to react positively to player dialogue at certain speechcraft thresholds (25, 50, 70 and 90)
...
I have only tested a few of these effects in game, so my best advice for troubleshooting with a specific spell or ability is to inspect the NPC in the console and look for what relevant effect gets applied to them. Then, add the effect ID into the prompt file manually, in whichever tier you best think appropriate. 
